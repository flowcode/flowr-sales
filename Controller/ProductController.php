...
use Flower\ModelBundle\Entity\Sales\Product;
use Flower\SalesBundle\Form\Type\ProductType;
...
class ProductController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $qb = $em->getRepository('FlowerModelBundle:Sales\Product')->createQueryBuilder('p');
     ...
     * @Method("POST")
     * @Template("FlowerSalesBundle:Product:new.html.twig")
     */
