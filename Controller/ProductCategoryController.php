...
use Flower\ModelBundle\Entity\Sales\ProductCategory;
use Flower\SalesBundle\Form\Type\ProductCategoryType;
...
class ProductCategoryController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $qb = $em->getRepository('FlowerModelBundle:Sales\ProductCategory')->createQueryBuilder('p');
     ...
     * @Method("POST")
     * @Template("FlowerSalesBundle:ProductCategory:new.html.twig")
     */
