...
use Flower\ModelBundle\Entity\Sales\Service;
use Flower\SalesBundle\Form\Type\ServiceType;
...
class ServiceController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $qb = $em->getRepository('FlowerModelBundle:Sales\Service')->createQueryBuilder('s');
     ...
     * @Method("POST")
     * @Template("FlowerSalesBundle:Service:new.html.twig")
     */
